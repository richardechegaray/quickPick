...
public interface ListApi {
    ...
    @POST("list")
    Call<ListPayload> createList(@Header("facebooktoken") String facebookToken, @Body CreateOrUpdateListRequest request);

    @PUT("list/{listId}")
    Call<ListPayload> updateList(@Header("facebooktoken") String facebookToken, @Path("listId") String listId,
                                 @Body CreateOrUpdateListRequest request);
